...
<div id="header">
    <div class="wrapper">
        <h1 id="logo">
            <a title="新品中心" target="_top" href="http://xin.taobao.com">
                <img src="http://img01.taobaocdn.com/tps/i1/T1FIqQXbtjXXXXXXXX-140-41.png" width="140" height="41" alt="新品中心">
            </a>
        </h1>
        <div class="search">
    ...
    <div id="nav">
        <ul class="main-nav clearfix">
            ...
            <li>
                <a target="_blank" href="http://girl.taobao.com/girl/xin.htm">女装新品</a>
            </li>
